                ...
                <div id="compiled-code" class="compiled-code">
                    {
                        ...
                        Object.keys(compiled.contracts).map((fileName, index) => {
                            return (
                                <div>
                                    <h2 class="text-success">{fileName}</h2>
                                    {
                                        Object.keys(compiled.contracts[fileName]).map((contractName) => {
                                            const bytecode = compiled.contracts[fileName][contractName].bytecode;
