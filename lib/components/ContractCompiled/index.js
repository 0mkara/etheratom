                    ...
                    <Tabs>
                        <TabList>
                            <div className="tab_btns">
                                ...
                                <button className="btn icon icon-desktop-download inline-block-tight icon-button"
                                    title={"Save "+savePath } onClick={this._saveABI}></button>
                        ...
                        {/* <TabPanel>
                            <div className="save-abi">
                                <button className="btn">Save as:</button>
                                <input className="inputs" value={savePath} />
                                <button className="btn btn-primary inline-block-tight" onClick={this._saveABI}>Save</button>
                            </div>
                        </TabPanel> */}
                    </Tabs>
                </div>
