        ...
        return (
            <div class="web3-decoder">
                <div class="flex-column">
                    ...
                    <div class="block">
                        <button class='btn inline-block-tight' onClick={this._encFuncSig}>
                            Encode func signature
                        </button>
                        <button class='btn inline-block-tight' onClick={this._encEvntSig}>
                            Encode event signature
                        </button>
                        <button class='btn inline-block-tight' onClick={this._encFuncCall}>
                            Encode func call
                        </button>
                        <button class='btn inline-block-tight' onClick={this._encParams}>
                            Encode Parameter/s
                        </button>
                        <button class='btn inline-block-tight' onClick={this._decParams}>
                            Decode Parameter/s
                        </button>
                        <button class='btn inline-block-tight' onClick={this._decLog}>
                            Decode Log
                        </button>
                    </div>
                </div>
