...
class NodeControl extends React.Component {
    ...
    async componentDidUpdate(prevProps, prevState) {
        ...
        if (this.state.httpProvider !== client.isHttpProvider) {
            this.setState({ httpProvider: client.isHttpProvider, connected: client.hasConnection });
        }
        if (this.state.wsProvider !== client.isWsProvider) {
            this.setState({ wsProvider: client.isWsProvider, connected: client.hasConnection });
        }
    }
    async _refreshSync() {
