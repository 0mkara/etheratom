                ...
                </ul>
                {
                    ...
                    <ul class="list-group">
                        <li class='list-item'>
                            ...
                            <progress class='inline-block' max='100' value={ (100 * (status.currentBlock/status.highestBlock)).toFixed(2) }></progress>
                            <span class='inline-block'>{ (100 * (status.currentBlock/status.highestBlock)).toFixed(2) }%</span>
                        </li>
                        <li class='list-item'>
