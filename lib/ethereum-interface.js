...
useTestRpc = atom.config.get('etheratom.useTestRpc');
...
module.exports = AtomSolidity = {
	...
	activate: function(state) {
		...
		atom.config.observe('etheratom.rpcAddress', function(newValue) {
			var urlPattern;
		...
		// Initiate env
		this.load();
		this.atomSolidityView.createCompilerOptionView('solcjs');
	},
	deactivate: function() {
