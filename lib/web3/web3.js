...
import { SET_COMPILED, ADD_INTERFACE, SET_COMPILING, SET_ERRORS, ADD_PENDING_TRANSACTION, SET_EVENTS } from '../actions/types'
...
export default class Web3Env {
	...
	subscribeToWeb3Events() {
		...
		if(Object.is(this.web3.currentProvider.constructor, Web3.providers.WebsocketProvider)) {
			console.log("Provider is websocket. Creating subscriptions....");
