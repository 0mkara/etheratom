...
export default class View {
    ...
    async createCoinbaseView() {
        try {
            ...
            ReactDOM.render(<CoinbaseView store={this.store} helpers={this.helpers} web3={this.web3} />, document.getElementById('accounts-list'));
        } catch (e) {
            console.log(e);
    ...
    createTabView() {
        ReactDOM.render(<TabView store={this.store} helpers={this.helpers} web3={this.web3}/>, document.getElementById('tab_view'));
    }
    createVersionSelector() {
        ReactDOM.render(<VersionSelector store={this.store} web3={this.web3}/>, document.getElementById('version_selector'));
    }
