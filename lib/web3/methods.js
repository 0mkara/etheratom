...
import { setInstance, setDeployed, addNewEvents, setMining, setHashrate, setGasEstimate } from '../actions';
    ...
    web3ProcessHandler() {
        this.hookWeb3ChildProcess.on('message', message => {
            ...
            if (message.hasOwnProperty('transaction')) {
                ...
                setInstance({ contractName, instance: Object.assign({}, this.contract) });
                ...
                const contractName = message['contractName'];
                setInstance({ contractName, instance: Object.assign({}, contract) });
                ...
                this.showOutput({ address: this.contract.options.address, data: message['callResult'] });
